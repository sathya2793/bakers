...
const Home = () => {
  ...
  const occasionProducts = [
    {
      img: custom1,
      buttonName: "WEDDING CAKES",
      link: "/product/wedding-cake"
    },
    {
      img: custom2,
      buttonName: "BIRTHDAY CAKES"
    },
    {
      img: custom3,
      buttonName: "BABY SHOWER CAKES"
    },
    {
      img: custom1,
      buttonName: "ANNIVERSARY CAKES"
    },
    {
      img: custom2,
      buttonName: "PHOTOSHEET CAKES"
    },
  ];
  return (
    <div className="home">
